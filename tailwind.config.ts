  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'mesh-gradient': 'radial-gradient(at 40% 20%, hsla(262, 83%, 58%, 0.1) 0px, transparent 50%), radial-gradient(at 80% 0%, hsla(189, 75%, 75%, 0.1) 0px, transparent 50%), radial-gradient(at 0% 50%, hsla(262, 83%, 58%, 0.05) 0px, transparent 50%)',
      },
    },
  },
