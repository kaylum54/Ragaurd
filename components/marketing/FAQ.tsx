    ...
    <section ref={sectionRef} className="py-24 md:py-32 bg-white relative" id="faq">
      <div className="container relative">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-0 border border-navy-100 rounded-lg overflow-hidden">
            {faqs.map((faq, index) => {
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    !isLast && 'border-b border-navy-100'
                  )}
                ...
                >
                  ...
                  >
                    <span className={cn(
                      ...
                      isOpen ? 'text-navy-950' : 'text-navy-600 group-hover:text-navy-950'
                    )}>
                      {faq.question}
                    </span>

                    <div className={cn(
                      'w-8 h-8 flex items-center justify-center shrink-0 transition-all duration-300 rounded',
