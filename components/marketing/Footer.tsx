  ...
  return (
    <footer className="bg-navy-950 border-t border-navy-800">
      <div className="container py-16">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10">
          <div className="col-span-2">
            ...
            <div className="mt-8">
              <Link
                href="/signup"
                className="inline-flex items-center gap-2 px-5 py-2.5 bg-white text-navy-950 text-sm font-semibold hover:bg-navy-100 transition-colors"
              >
          ...
          <div>
            <h4 className="text-[10px] font-bold text-navy-500 uppercase tracking-[0.2em] mb-5">Product</h4>
          ...
          <div>
            <h4 className="text-[10px] font-bold text-navy-500 uppercase tracking-[0.2em] mb-5">Resources</h4>
            <ul className="space-y-3">
          ...
          <div>
            <h4 className="text-[10px] font-bold text-navy-500 uppercase tracking-[0.2em] mb-5">Legal</h4>
            <ul className="space-y-3">
        ...
        <div className="mt-16 pt-8 border-t border-navy-800 flex flex-col md:flex-row justify-between items-center gap-6">
